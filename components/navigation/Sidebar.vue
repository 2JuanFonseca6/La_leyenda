    ...
    <div
      ...
      <div class="flex flex-1 md:justify-start md:items-center md:flex-col gap-2 overflow-x-auto flex-nowrap no-scrollbar w-auto md:w-full">
        ...
        <div class="hidden md:flex flex-col items-center justify-center gap-2 mb-4">
          ...
          <span class="mt-1 px-3 py-1 rounded-full text-xs font-semibold bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-600 select-none">
            Rol: {{ userRole }}
          </span>
        </div>
        ...
        <NavButtons icon="i-healthicons-syringe-outline" text="Pajillas" to="/stock/pajillas" />
        <NavButtons icon="i-heroicons-rectangle-group" text="Lotes" to="/corrals" />
